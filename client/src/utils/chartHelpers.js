...
export const DEFAULT_STREAM_UNITS = {
  ...
  'SENSOR_VOLTAGE': { unit: 'V', label: 'Sensor Voltage', category: 'EPU' },
  'SENSOR_CURRENT': { unit: 'A', label: 'Sensor Current', category: 'EPU' },
  'CURRENT_DENSITY': { unit: 'A/m²', label: 'Current Density', category: 'EPU' },
